...
export default function CustomField({ onAddOtherValue }: { onAddOtherValue?: (otherValue: string) => void }) {
  const [otherValue, setOtherValue] = useState('');

  return <div className="flex flex-row items-center space-x-2 w-full">
