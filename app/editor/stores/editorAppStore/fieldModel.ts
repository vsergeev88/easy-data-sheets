...
export const BaseFieldModel = types.model({
  ...
  name: types.string,
  type: types.union(types.literal(FIELD_TYPES.TEXT), types.literal(FIELD_TYPES.CHECKBOX)),
...
export const CheckboxFieldModel = BaseFieldModel.named('CheckboxFieldModel').props({
  type: types.literal(FIELD_TYPES.CHECKBOX),
  items: types.array(types.string),
  withCustomField: types.optional(types.boolean, false),
})
export interface ICheckboxFieldModel extends Instance<typeof CheckboxFieldModel> {}
