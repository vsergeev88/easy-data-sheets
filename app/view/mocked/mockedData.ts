      ...
      fields: [
        {
          ...
          items: ["Орошение", "Навозоудаление", "Промышленные мотопомпы для грязной воды", "Пожаротушение", "Размыв грунта и откачка пульп", "Водоотлив в добывающей промышленности (ДПИ)", "Чрезвычайные ситуации", "Сезонная опрессовка АОМЦ", "Агрегаты АН и АО", "Насосные блоки для буровых скважин",
          ]
        }
      ]
    }
